...
const STRINGS = {
  en: {
    ...
    hero: {
      ...
      proof_loc: 'Alexandria & Marksville',
    ...
    locations: {
      ...
      title_b: 'of care.',
      lead: 'Alexandria and Marksville. Open-now status, drive times, direct phone.',
  ...
  es: {
    ...
    hero: {
      ...
      proof_loc: 'Alexandria y Marksville',
    ...
    locations: {
      ...
      title_b: 'de atención.',
      lead: 'Alexandria y Marksville. Estado abierto ahora, tiempo en auto, teléfono directo.',
