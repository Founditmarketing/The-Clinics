...
const STRINGS = {
  en: {
    ...
    hero: {
      ...
      lead:
        'Hometown trust meets modern clinical standards. Family medicine, on-site cardiac diagnostics, gastro, podiatry, and labs, delivered by clinicians who chose to live here too.',
      cta_primary: 'Book a visit',
      cta_secondary: 'Explore services',
      cta_tertiary: 'Same-day care',
      proof_title: 'Same-day appointment open',
      proof_loc: 'Alexandria',
      proof_time: '11:40 AM today',
      meta_open: 'Open now',
      meta_closed: 'Closed',
      meta_drive: 'min drive',
      meta_nearest: 'Our clinic',
      stats_locations: 'location',
      stats_providers: 'providers',
      stats_years: 'years in Cenla',
      stats_pcmh: 'Same-roof answers',
    },
    intent: {
      ...
      sick: {
        ...
        cta: 'Reserve same-day slot',
      },
      primary: {
        t: 'I need a primary doctor',
        d: 'Match with a provider who takes your insurance and your pace.',
        cta: 'Find my doctor',
      },
      cardiac: {
        t: 'I need cardiac answers',
        d: 'EKG, Holter, stress test, ultrasound. Read by your provider, same visit.',
        cta: 'Start cardiac visit',
      },
    },
    insurance: {
      eyebrow: 'Insurance',
    ...
    services: {
      ...
      title_b: '.',
      lead:
        'From annual physicals to cardiac diagnostics, in-house labs, and X-ray, theCLINICS handles the everyday and the unexpected.',
    ...
    locations: {
      ...
      title_b: 'of care.',
      lead: '1587 N Bolton Avenue. Open now status, live wait time, direct phone.',
    ...
    cta: {
      ...
      title_b: '.',
      lead:
        'Whether you need a primary care physician, a same-day visit, a pediatric checkup, or cardiac diagnostics, theCLINICS is one tap away.',
      btn_a: 'Book a visit',
    ...
    booking: {
      ...
      reason_cardiac: 'Cardiac diagnostics',
  ...
  es: {
    ...
    hero: {
      ...
      mobile_hl_2_after: '',
      lead:
        'Confianza local con estándares clínicos modernos. Medicina familiar, diagnóstico cardíaco en sitio, gastroenterología, podiatría y laboratorio, con clínicos que también viven aquí.',
      ...
      meta_nearest: 'Nuestra clínica',
      stats_locations: 'sede',
      stats_providers: 'proveedores',
      stats_years: 'años en Cenla',
      stats_pcmh: 'Respuestas en una sola visita',
    },
    intent: {
      ...
      sick: {
        ...
        cta: 'Reservar mismo día',
      },
      primary: {
        t: 'Necesito médico de cabecera',
        d: 'Encuentre un proveedor que acepte su seguro y su ritmo.',
        cta: 'Encontrar médico',
      },
      cardiac: {
        t: 'Necesito respuestas cardíacas',
        d: 'EKG, Holter, prueba de esfuerzo, ultrasonido. Leído en la misma visita.',
        cta: 'Iniciar visita cardíaca',
      },
    },
    insurance: {
      eyebrow: 'Seguro',
    ...
    services: {
      ...
      title_b: '.',
      lead:
        'Desde exámenes anuales hasta diagnóstico cardíaco, laboratorio y rayos X, en una sola visita.',
    ...
    locations: {
      ...
      title_b: 'de atención.',
      lead: '1587 N Bolton Avenue. Estado abierto, espera en vivo, teléfono directo.',
    ...
    cta: {
      ...
      title_b: '.',
      lead:
        'Sea atención primaria, una visita el mismo día, una revisión pediátrica o diagnóstico cardíaco, theCLINICS está a un toque.',
    ...
    booking: {
      ...
      reason_cardiac: 'Diagnóstico cardíaco',
