  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .map-pin-dot { width: 14px; height: 14px; border-radius: 999px; background: var(--terracotta); box-shadow: 0 0 0 4px rgba(225, 27, 27,0.18), 0 8px 18px -6px rgba(225, 27, 27,0.45); transition: 220ms ease; }
        .map-pin.is-active .map-pin-dot { background: var(--terracotta-deep); box-shadow: 0 0 0 6px rgba(225, 27, 27,0.24), 0 0 0 12px rgba(225, 27, 27,0.10), 0 10px 24px -6px rgba(225, 27, 27,0.45); transform: scale(1.15); }
