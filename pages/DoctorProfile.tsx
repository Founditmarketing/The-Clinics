...
import { Calendar, MapPin, Clock, Phone, ArrowLeft, Star, Shield, Award, User as UserIcon } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 md:px-6 py-12">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                    <div className="flex flex-col md:flex-row">
                        ...
                        {/* Content Column */}
                        <div className={`${doctor.image ? 'md:w-2/3 lg:w-3/4' : 'w-full'} p-8 md:p-12 ${!doctor.image ? 'flex flex-col items-center justify-center text-center min-h-[500px] py-20' : ''}`}>
                            <div className={`hidden md:block mb-6 ${!doctor.image ? 'text-center' : ''}`}>
                                <h1 className="text-3xl md:text-4xl font-serif-heading font-bold text-slate-900 mb-2">{doctor.name}</h1>
                                <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-medical-50 text-medical-700 font-medium text-sm ${!doctor.image ? 'mx-auto' : ''}`}>
